...
export default function Banner_section({ BannerData }) {
  return (
    BannerData?.length > 0 &&
    BannerData?.map((Data) => {
      return (
        <section
          key={Data._id}
          className=" lg:text-start text-center min-h-screen lg:h-screen   justify-center   flex flex-wrap  items-center w-full  bg-[#242424] "
        >
          <motion.div className="lg:mr-28 lg:w-[40%]  mr-0 p-10 lg:p-0 ">
            ...
            >
              {Data?.description ||
                `  I am a motivated and versatile individual, always eager to take on  new challenges. With a passion for learning, I am dedicated to
              delivering high-quality results. My positive attitude and growth
              mindset enable me to adapt quickly and contribute meaningfully to
              any endeavor. I strive for continuous improvement and am committed
